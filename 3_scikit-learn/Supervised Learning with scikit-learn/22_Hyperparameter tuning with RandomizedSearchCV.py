...
#¿Por cuál de los siguientes motivos le gustaría utilizar un conjunto de retención para el final?
Desea estar absolutamente seguro de la capacidad de su modelo para generalizar a datos invisibles

¡Correcto! La idea es ajustar los hiperparámetros del modelo en el conjunto de entrenamiento y luego evaluar su rendimiento en el conjunto de retención que nunca antes había visto.
