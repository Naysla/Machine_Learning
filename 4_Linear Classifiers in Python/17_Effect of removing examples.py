...
#Los vectores de soporte se definen como ejemplos de entrenamiento que influyen en el límite de decisión. En este ejercicio, observará este comportamiento eliminando vectores no compatibles del conjunto de entrenamiento.
...
#Devuelve tambien una grafica donde define tres areas para la calidad del vino
